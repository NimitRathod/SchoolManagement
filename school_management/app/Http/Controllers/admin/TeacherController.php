...
class TeacherController extends Controller
{
    ...
    public function __construct()
    {
        $this->modules = [
            ...
            'folder_path' => 'teacher',
            'route' => 'teachers',
            'table_name' => (new Teachers())->getTable(),
            'permisstion_prefix' => 'teachers',
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            if ($request->ajax()) {
                ...
                $data = Teachers::with(['roles']);
                $data = $data->whereHas("roles", function($q){
                    $q->whereIn("name", ["Teachers"]);
                });
    ...
    */
    public function edit(string $id)
    {
        try{
            ...
            $edit = Teachers::with('roles')->findOrFail($id);
    ...
    public function destroy(Request $request, string $id)
    {
        try{
            $modules = $this->modules;
            $dataDelete = Teachers::findOrFail($id);
            if($dataDelete){
                if($request->ajax()){
