...
<head>
    ...
    <title> @yield('title') - {{ config('app.name', 'Nimit Rathod') }}</title>
...
<body>
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">{{ config('app.name', 'Company Name') }}</a>
...
@stack('pageScriptFiles')
<script>
    $('.select2' ).select2();
</script>
@yield('pageLeavelScript')
</body>
</html>